                    ...
                    <div class="right-content">
                        ...
                        ?>
                            <div class="quote">
                                ...
                                <p><?php echo nl2br(htmlspecialchars($product_specification)); ?></p>
                            </div>
                                ...
                                <div class="quantity-content">
                                    ...
                                    <div class="right-content">
                                        <div class="quantity buttons_added">
                                            <button type="button" class="btn btn-danger quantity-button" onclick="decrementQuantity()">-</button>

                                            <input name="quantity" id="product-quantity" type="number" step="1" min="1" max="" value="1" title="Qty" class="input-text qty text" size="4" pattern="" inputmode="">
                                            <button type="button" class="btn btn-success quantity-button" onclick="incrementQuantity()">+</button>
                                        </div>
                                    </div>
                                </div>
